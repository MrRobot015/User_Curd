                ...
                <div className="card-body">
                  ...
                  <form className="forms-sample">
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control" id="exampleInputName15" placeholder="+249"/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control" id="exampleInputName1" placeholder="Software developer"/>
                    </div>

                    <div className="form-group">
                      <label htmlFor="exampleInputName1">Salary</label>
                      <input type="number" className="form-control" id="exampleInputName1" placeholder="0"/>
                    </div>
